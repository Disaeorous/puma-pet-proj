		...
		return `
			<section class="intro">
				<div class="container">
					...
					<article class="intro-slider">
						<div class="intro-slider__left">
							<h1 class="intro-slider__title">
								Life is better in running <span>shose</span>
							</h1>

							<p class="intro-slider__description show">Lorem ipsum dolor sit, amet consectetur adipisicing, elit.</p>

							<p class="intro-slider__description">rwwr</p>
						</div>

						<div class="intro-slider__right">
							<a class="intro-slider__item show" href="#">
								<img class="intro-slider__item-img" src="../graphics/img/shose_1.png" alt="Red shose">
							</a>

							<a class="intro-slider__item" href="#">
								<img class="intro-slider__item-img" src="../graphics/img/shose_2.png" alt="Red shose">
							</a>
							<button id="slider-handle__right" class="slider-handle__right"></button>
						</div>
					</article>

					<div class="slider-filter">
						<div class="slider-filter__items">
							<a class="slider-filter__item" href="#">
								<h1 class="slider-filter__title">Brand</h1>
								<p class="slider-filter__content">
									<strong>Puma</strong>
								</p>
							</a>

							<a class="slider-filter__item" href="#">
								<h1 class="slider-filter__title">Person</h1>
								<p class="slider-filter__content">
									<strong>man</strong>
								</p>
							</a>
							...
							<a class="slider-filter__item" href="#">
								<h1 class="slider-filter__title">Size</h1>
								<p class="slider-filter__content">
									<strong>large</strong>
								</p>
							</a>
							...
							<a class="slider-filter__item" href="#">
								<h1 class="slider-filter__title">Price</h1>
								<p class="slider-filter__content">
									<strong>$150</strong>
								</p>
							</a>
						...
						<button class="cta-order btn">Buy now</button>
						<div class="modal">
							<article class="modal-content">
